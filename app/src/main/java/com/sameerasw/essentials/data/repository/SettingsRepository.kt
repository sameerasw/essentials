...
import com.sameerasw.essentials.domain.model.AppSetting
...
class SettingsRepository(private val context: Context) {
    ...
    companion object {
        ...
        const val KEY_SHUT_UP_APPS_CONFIG = "shutup_apps_config"
    ...
    fun loadShutUpConfigs(): List<ShutUpAppConfig> {
        val json = prefs.getString(KEY_SHUT_UP_APPS_CONFIG, null)
        return if (json != null) {
            try {
                gson.fromJson(
                    json,
    ...
    fun saveShutUpConfigs(configs: List<ShutUpAppConfig>) {
        val json = gson.toJson(configs)
        putString(KEY_SHUT_UP_APPS_CONFIG, json)
    }
