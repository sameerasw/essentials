...
class AppFlowHandler(
    ...
    private fun checkShutUp(packageName: String) {
        ...
        val configs: List<com.sameerasw.essentials.domain.model.ShutUpAppConfig> = try {
        ...
        scope.launch(Dispatchers.IO) {
            ...
            com.sameerasw.essentials.utils.ShutUpManager.applyShutUpSettings(context, config)
        }
    }
